...
```javascript
        ...
        var php_mode = CodeMirrorGrammar.getMode(php_grammar);
        
        // 3. register the mode with Codemirror
        CodeMirror.defineMode("php", php_mode);
